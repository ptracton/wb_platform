...
vlog ${1}.v +incdir+../testbench +incdir+../simulation  +incdir+../testbench  +define+RTL
      ...
      vlog ../rtl/daq/daq_sm.v +define+SIM +define+RTL
      vlog ../rtl/dsp/dsp_slave.v
      vlog ../rtl/dsp/dsp_top.v
      vlog ../rtl/dsp/dsp_sm.v +define+SIM
      vlog ../rtl/dsp/dsp_equations_top.v
      vlog ../rtl/dsp/dsp_equation_sum.v
      vlog ../rtl/dsp/dsp_equation_multiply.v
      vlog ../rtl/dsp/dsp_equation_dtree.v +define+SIM
      vlog ../rtl/dsp/priority_encoder.v
      ...
      vlog ../testbench/data_file_monitor.v  +incdir+../simulation  +incdir+../testbench
      vlog ../testbench/daq_injector.v  +incdir+../simulation  +incdir+../testbench
